  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section className="section" id="experience" data-reveal="section"><div className="container"><div className="section-heading"><div><p className="section-kicker">04 / Experience</p><h2>Perjalanan<br /><em>sejauh ini.</em></h2></div></div><div className="timeline">{experiences.map((experience) => <div className="timeline-item" data-reveal="card" key={experience.company}><span className="timeline-dot" /><article className="card timeline-card"><div className="timeline-meta"><span>{experience.date}</span><span>JAKARTA, ID</span></div><h3>{experience.role}</h3><p>{experience.company}</p><ul><li>{experience.body}</li><li>Kolaborasi, dokumentasi sistem, dan pengembangan antarmuka responsif.</li></ul></article></div>)}</div></div></section>

        <section className="section contact" id="contact" data-reveal="section"><div className="container"><div className="contact-box" data-reveal="content"><div><p className="section-kicker">05 / Mari ngobrol</p><h2>Punya ide?<br />Saya siap <em>mendengar.</em></h2><p className="contact-copy">Sedang mencari web developer, IT support, atau sekadar ingin bertukar cerita soal sistem? Kirim pesan. Saya akan membalas secepatnya.</p></div><div className="contact-actions"><a className="button" href="mailto:rizkiarbi65@gmail.com">Email saya <Arrow /></a><a className="button" href="https://linkedin.com/in/rizkiarbiansyah" target="_blank" rel="noreferrer">LinkedIn <Arrow /></a><a className="button" href="https://github.com/greedykid" target="_blank" rel="noreferrer">GitHub <Arrow /></a></div></div></div></section>
      </main>
